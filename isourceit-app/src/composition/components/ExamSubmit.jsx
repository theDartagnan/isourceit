    ...
    <Row className="justify-content-center">
      <Col xs={12} sm={10} md={8} lg={6}>
        <Alert variant="primary">
          <Alert.Heading>Exam Submission</Alert.Heading>
          <p>
            You are goind to sumbit this exam. Once done, you will not be able to edit any
        ...
        <Row className="justify-content-between">
          ...
          <Col xs="auto">
            <Button onClick={submitExam} variant="danger" size="lg">
              <FontAwesomeIcon
                icon={faCheckToSlot}
                aria-hidden="true"
...
ExamSubmit.propTypes = {
  exam: MPropTypes.objectOrObservableObject.isRequired,
};

export default observer(ExamSubmit);
